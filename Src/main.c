...
////Sine Wave PWM ///////////////////
const int16_t pwmSin[] = {180,183,186,189,193,196,199,202,
...
//  TIM1->CCR4 = 100;  // set in 10khz loop to match pwm cycle timed to end of pwm on
  ...
  LL_TIM_CC_EnableChannel(IC_TIMER_REGISTER, LL_TIM_CHANNEL_CH2);  // input capture
  LL_TIM_CC_EnableChannel(IC_TIMER_REGISTER, LL_TIM_CHANNEL_CH4);  // input capture
#endif
